...
public class ExportExcelKit {
    // 这是记录log日志的，没有配的话可忽略
    public static final Logger log = LogManager.getLogger(ExportExcelKit.class);
     ...
     * @throws
     */
    public static void exportDataToExcel(Map<String, String> title, Map<String, Integer> position, List<LinkedHashMap<String, Object>> data, String sheetName, OutputStream outputStream) throws IOException {
